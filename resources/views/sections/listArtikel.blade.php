@php
    function thumbnailUrl($thumbnail)
    {
        ...
        return Str::startsWith($thumbnail, ['http://', 'https://']) ? $thumbnail : asset('storage/' . $thumbnail);
    }
@endphp
    ...
    <div class="grid md:grid-cols-3 gap-6">
        @foreach ($contents as $item)
            <a href="{{ route('article.detail', $item->slug) }}"
                ...
                <img src="{{ thumbnailUrl($item->thumbnail) }}" class="w-full h-40 object-cover rounded-t-xl">
                <div class="p-4">
