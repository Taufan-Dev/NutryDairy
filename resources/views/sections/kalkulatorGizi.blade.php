    ...
    <section class="flex items-center justify-center py-10">
        <form class="p-6 rounded-lg border-primary border-2 w-full max-w-4xl flex flex-col md:flex-row gap-6"
            ...
            <div class="w-full">
                ...
                <button type="submit"
                    class="mt-6 w-full bg-white border-primary border-2 text-primary py-2 rounded-lg hover:bg-primary hover:bg-sky-500 hover:text-white">
                    Hitung Status Gizi
                </button>
            </div>
        </form>
